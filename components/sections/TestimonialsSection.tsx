/**
 * ARCHIV – nicht mehr eingebunden (seit 02.09.2026).
 *
 * Diese Sektion zeigte drei erfundene Platzhalter-Kundenstimmen
 * („Sandra K.", „Markus T.", „Julia M.") mit 5-Sterne-Bewertungen.
 * Erfundene Bewertungen sind irreführende geschäftliche Handlungen
 * (§ 5 UWG, Anhang Nr. 23b UWG) und damit ein Abmahnrisiko. Die Startseite
 * verwendet stattdessen HowIWorkSection.tsx („So arbeite ich").
 *
 * Der Code bleibt hier als Kommentar erhalten, falls später echte,
 * ausdrücklich freigegebene Kundenstimmen eingetragen werden sollen.
 * Dann bitte: echte Personen, dokumentierte Einwilligung, keine Sterne
 * ohne echtes Bewertungssystem.
 *
 * ---------------------------------------------------------------------
 * const testimonials = [
 *   {
...
// Platzhalter-Export, damit die Datei ein Modul bleibt. Wird nirgends verwendet.
export const TESTIMONIALS_ARCHIVED = true;
